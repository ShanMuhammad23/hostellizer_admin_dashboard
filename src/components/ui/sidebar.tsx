  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-64 transition-[left,right,width] duration-200 ease-linear md:flex bg-sidebar",
          side === "left"
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-primary mx-2 w-auto", className)}
      {...props}
    />
  )
}
